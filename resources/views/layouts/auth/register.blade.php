...
<body class="flex w-full h-screen justify-center bg-[#070F2B] px-8 md:px-12 lg:px-32 py-[120px] font-roboto">
    ...
    <div class="flex w-full h-contain text-white shadow-3xl z-10">
        ...
        <section class="flex flex-col w-full bg-[#070F2B] px-8 md:px-32 text-center justify-center gap-y-6 rounded-xl lg:rounded-l-none lg:rounded-r-xl">
            ...
            <form action="" method="post" class="flex flex-col gap-y-4">
                <input class="bg-transparent border-[1px] border-[#FBFBFB] p-3 text-sm rounded-lg" type="text" name="name" placeholder="Nama Lengkap">
            ...
            <button type="submit" class="w-full px-[16px] py-[12px] text-[16px] font-semibold bg-[#1C4FFF] rounded-lg">Register</button>
        </section>
    </div>
</body>
</html>
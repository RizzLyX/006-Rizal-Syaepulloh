...
<head>
    ...
    <title>ReelList - Data Film</title>
</head>
<body class="flex bg-[#0F193A] font-roboto">
    @include('components.sidebar')
    <div class="flex flex-col w-full h-screen gap-y-10 px-[52px] py-[60px]">
        <div class="flex justify-between">
            <h1 class="text-white text-3xl font-bold">List Film</h1>
            <button class="flex items-center justify-center w-fit h-auto px-[16px] py-[12px] text-[13px] text-[#FFFFFF] md:text-[16px] bg-[#1C4FFF] hover:bg-[#798CFF] active:bg-[#1C4FFF] rounded-lg">Create Data</button>
        </div>
